...
// lw1.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Clw1App, CWinApp)
...
// Единственный объект Clw1App

Clw1App theApp;


// Инициализация Clw1App

BOOL Clw1App::InitInstance()
{
