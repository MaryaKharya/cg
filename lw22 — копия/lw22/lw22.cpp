...
// lw22.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Clw22App, CWinApp)
...
BOOL Clw22App::InitInstance()
{
	...
	if (Gdiplus::GdiplusStartup(&m_tokenGdiplus, &input, &output) != Gdiplus::Ok)
	{
