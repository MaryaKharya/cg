...
// lw2.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Clw2App, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &Clw2App::OnAppAbout)
...
Clw2App::Clw2App() noexcept
{
	...
	SetAppID(_T("lw2.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект Clw2App

Clw2App theApp;


// Инициализация Clw2App

BOOL Clw2App::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_lw2TYPE,
		RUNTIME_CLASS(Clw2Doc),
		RUNTIME_CLASS(CChildFrame), // настраиваемая дочерняя рамка MDI
		RUNTIME_CLASS(Clw2View));
	if (!pDocTemplate)
		return FALSE;
...
void Clw2App::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// Методы загрузки или сохранения настроек Clw2App

void Clw2App::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void Clw2App::LoadCustomState()
{
}

void Clw2App::SaveCustomState()
{
}
