...
// lw2_2.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Clw22App, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &Clw22App::OnAppAbout)
...
Clw22App::Clw22App() noexcept
{
	...
	SetAppID(_T("lw22.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект Clw22App

Clw22App theApp;


// Инициализация Clw22App

BOOL Clw22App::InitInstance()
{
...
// Обработчики сообщений Clw22App
...
void Clw22App::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// Методы загрузки или сохранения настроек Clw22App

void Clw22App::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void Clw22App::LoadCustomState()
{
}

void Clw22App::SaveCustomState()
{
}
